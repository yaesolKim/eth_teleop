...
position_limits = [[0.4, 0.5], [-0.9, 0.9], [0.05, 0.9]]
...
def haptic_callback(data):
    ...
    # hold the configuration. TODO: render the texture according to the roughness_level
    # else:
    #    rospy.loginfo("contact")
...
def wait_for_initial_pose():
    ...
    rospy.loginfo("current position: " + str(haptic_pose.pose.position))
    rospy.loginfo("current orientation: " + str(haptic_pose.pose.orientation))
