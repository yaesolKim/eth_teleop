...
int main(int argc, char** argv)
{
  ...
  std::cout << std::endl <<"left pos: " << current_pose.pose.position.x << ", " << current_pose.pose.position.y << ", " << current_pose.pose.position.z << std::endl;
  ...
  move_group_interface.attachObject(object_to_attach.id, "panda_ee");
